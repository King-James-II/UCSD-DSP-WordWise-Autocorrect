...
public class NearbyWords implements SpellingSuggest {
	...
	public List<String> suggestions(String word, int numSuggestions) {
		...
		while (!queue.isEmpty() && retList.size() < numSuggestions) {
			...
			List<String> neighbors = distanceOne(currStr, true);
			for(String currWord : neighbors) {
   ...
   public static void main(String[] args) {
	   ...
	   w.insertions(word, suggest, true);
	   w.substitution(word, suggest, true);
	   w.deletions(word, suggest, true);
	   System.out.println("Spelling Insertions for \""+word+"\" are:");
	   System.out.println(suggest);
   }
